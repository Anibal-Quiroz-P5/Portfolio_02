...
- `dist/`: carpeta destinada a...
- `public/images/`: carpeta destinada a...
- `src/`: carpeta destinada a...
  - `controllers/`: carpeta destinada a...
  - `middlewares/`: carpeta destinada a...
  - `models/`: carpeta destinada a...
  - `repositories/`: carpeta destinada a...
  - `routes/`: carpeta destinada a...
